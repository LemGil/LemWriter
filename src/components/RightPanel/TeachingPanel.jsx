...
const TeachingPanel = ({ section, project, onResourceChange, collapsed }) => {
  ...
  return (
    <BasePanel tabs={tabs} activeTab={activeTab} onTabChange={setActiveTab} accent="ensenanza" collapsed={collapsed}>
      {(tab) => {
        switch (tab) {
          case 'text':
            return (
